...
- **Power** shows battery stats, switches power profiles (it remembers a separate choice for battery and AC), decides whether closing the lid suspends or keeps everything running, and prints some system info.
