...
- **Bluetooth** lists your devices with connect/disconnect and battery levels, and its **Accept files** switch receives files pushed from a paired phone — the phone's own share sheet, Android's *Bluetooth* target — straight into your downloads directory.
