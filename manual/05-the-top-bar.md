...
- **Power** shows battery stats, switches power profiles (it remembers a separate choice for battery and AC), and — when the hardware can do it — turns the 80% battery cap on or off.
