...
### Tailscale, Dropbox, and Cloudflare

Three more widgets appear on the bar only once you install the matching service from **Install → Service**, and all three are worth knowing about because they do more than report status.
