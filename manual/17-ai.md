...
Ghost also has a `ghost-runtime` package for apps that provide their own UI on an Omarchy desktop. _Remove > AI > Ghost UI_ removes the HUD and keeps that runtime running, along with your ghost homes and credentials.
