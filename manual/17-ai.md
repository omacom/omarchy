...
The _Install > AI_ menu also carries a few graphical AI apps: the ChatGPT desktop app, Ghost (a local AI persona with its own HUD, summoned with `Super + Ctrl + G`), Grok Bot for chatting with xAI's models, Hermes Desktop, OpenClaw, and the Perplexity desktop app.
