...
The _Install > AI_ menu also carries a few graphical AI apps: the ChatGPT desktop app, the Claude desktop app (Anthropic's Linux beta, with Chat, Cowork, and Claude Code tabs), Grok Bot for chatting with xAI's models, Hermes Desktop, LM Studio Bionic, OpenClaw, and the Perplexity desktop app.
...
Omarchy recommends three ways of running local LLM models: LM Studio, LM Studio Bionic, and Ollama. LM Studio provides a GUI interface for finding open-weight models, installing them, and running them. It's a great way to get going easily, especially if you like tinkering with models and their settings. LM Studio Bionic offers an easier, more agentic experience focused on getting work done with open-weight models. Ollama offers a CLI for doing so similarly. But if you're new to local models, I'd start with LM Studio. You can install all three under _Install > AI_ in the Omarchy Menu.
