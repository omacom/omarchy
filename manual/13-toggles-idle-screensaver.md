...
`Super + Ctrl + L` locks the machine. That runs the lock screen from the Omarchy shell, blanks the display, and resets your keyboard layout to the first one so you're not typing your password in the wrong alphabet.
