{
    ...
    "colors": {
        ...
        "button.secondaryBackground": "{{ mix background foreground 12% }}",
        "button.secondaryHoverBackground": "{{ mix background foreground 18% }}",
        ...
        "commandCenter.activeBackground": "{{ mix background foreground 12% }}",
        ...
        "extensionButton.background": "{{ mix background foreground 12% }}",
        "extensionButton.foreground": "{{ foreground }}",
        "extensionButton.hoverBackground": "{{ mix background foreground 20% }}",
