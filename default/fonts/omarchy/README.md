...
- `U+E90F` — Phantombot, redrawn as a monochrome ghost silhouette from the project logo at <https://github.com/phantomyard/phantombot> (`www/assets/img/logo.png`), since upstream publishes no monochrome SVG
