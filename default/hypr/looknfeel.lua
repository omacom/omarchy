...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4.2, bezier = "easeOutExpo", style = "popin 90%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.7, bezier = "easeOutExpo", style = "popin 90%" })
hl.animation({ leaf = "fadeIn", enabled = true, speed = 1.73, bezier = "almostLinear" })
hl.animation({ leaf = "fadeOut", enabled = true, speed = 1.46, bezier = "almostLinear" })
hl.animation({ leaf = "fade", enabled = true, speed = 3.03, bezier = "quick" })
hl.animation({ leaf = "fadeSwitch", enabled = true, speed = 3.0, bezier = "quick" })
