...
-- splitratio 1.0 is even; splitratio always grows the split's first (left/top)
-- child, so we check which side the focused window is on and flip the ratio
-- when it is the second (right/bottom) one.
