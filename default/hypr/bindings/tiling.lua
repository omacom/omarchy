local window_vault = require("default.hypr.window-vault").for_hyprland()

o.bind("SUPER + W", "Safely close window", function()
  window_vault:stash_active()
end)
o.bind("SUPER + Q", "Close window permanently", hl.dsp.window.close())
o.bind("SUPER + SHIFT + T", "Restore last safely closed window", function()
  window_vault:restore_latest()
end)
o.bind("SUPER + SHIFT + Q", "Permanently close last safely closed window", function()
  window_vault:close_latest()
end)
o.bind("SUPER + ALT + W", "Show Window Vault", function()
  window_vault:toggle()
end)
