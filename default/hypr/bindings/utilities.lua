o.bind("SUPER + SPACE", "Omarchy menu", hl.dsp.global("omarchy:menu-root"))
o.bind("SUPER + ALT + SPACE", "Apps menu", hl.dsp.global("omarchy:menu-apps"))
o.bind("SUPER + CTRL + E", "Emojis", "omarchy-shell shell toggle omarchy.emojis")
o.bind("SUPER + CTRL + C", "Capture menu", hl.dsp.global("omarchy:menu-capture"))
o.bind("SUPER + CTRL + O", "Toggle menu", hl.dsp.global("omarchy:menu-toggle"))
o.bind("SUPER + CTRL + H", "Hardware menu", hl.dsp.global("omarchy:menu-hardware"))
o.bind("SUPER + SHIFT + code:201", "Omarchy menu", hl.dsp.global("omarchy:menu-root"))
o.bind("SUPER + ESCAPE", "System menu", hl.dsp.global("omarchy:menu-system"))
...
o.bind("SUPER + CTRL + SPACE", "Background switcher", hl.dsp.global("omarchy:menu-background"))
o.bind("SUPER + SHIFT + CTRL + SPACE", "Theme menu", hl.dsp.global("omarchy:menu-theme"))
...
o.bind("SUPER + CTRL + S", "Share", hl.dsp.global("omarchy:menu-share"))

o.bind("SUPER + CTRL + PERIOD", "Transcode", "omarchy-transcode")

o.bind("SUPER + CTRL + R", "Set reminder", hl.dsp.global("omarchy:menu-reminder"))
