...
-- Launcher, image selector, emojis, clipboard, SpaceBeach, and keyboard-driven
...
hl.layer_rule({ match = { namespace = "^(omarchy-menu|omarchy-image-selector|omarchy-emojis|omarchy-clipboard|omarchy-spacebeach|omarchy-keyboard-panel)$" }, no_anim = true, animation = "none" })
