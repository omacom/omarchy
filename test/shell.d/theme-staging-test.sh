...
printf '[defaults]\nfill = "fit"\n' >"$hostile/backgrounds/backgrounds.toml"
printf '<svg xmlns="http://www.w3.org/2000/svg"/>\n' >"$hostile/backgrounds/art.svg"
...
assert_staged backgrounds/backgrounds.toml "background render metadata is staged"
assert_staged backgrounds/art.svg "an SVG in backgrounds/ is staged"
