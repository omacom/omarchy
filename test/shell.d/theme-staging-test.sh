...
colour_only=(btop.theme chromium.theme claude.json fcitx5-theme.conf helix.toml hermes.yaml hyprland-preview-share-picker.css keyboard.rgb obsidian.css pi.json shell.toml t3code.json vscode-theme.json)
