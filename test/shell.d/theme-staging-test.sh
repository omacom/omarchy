...
for generated in hyprland.lua neovim.lua gum_env.lua kitty.conf alacritty.toml foot.ini ghostty.conf starship.toml; do
...
denied=(alacritty.toml foot.ini ghostty.conf kitty.conf starship.toml gum_env.lua hyprland.lua neovim.lua vscode.json)
