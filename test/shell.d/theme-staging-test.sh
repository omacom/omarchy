...
colour_only=(btop.theme chromium.theme claude.json helix.toml hermes.yaml hunk.json hyprland-preview-share-picker.css keyboard.rgb obsidian.css pi.json shell.toml t3code.json vscode-theme.json)
