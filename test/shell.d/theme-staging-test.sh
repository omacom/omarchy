...
colour_only=(btop.theme chromium.theme claude.json helix.toml hermes.yaml hyprland-preview-share-picker.css keyboard.rgb mpv-console.conf mpv-context_menu.conf mpv-osc.conf obsidian.css pi.json shell.toml t3code.json vscode-theme.json)
