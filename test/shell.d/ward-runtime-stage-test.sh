...
for asset in worker.qml WidgetView.qml Ward/Desktop.qml Commons/Color.qml Ui/Panel.qml Services/PluginShellApi.qml Services/PluginRuntime.qml Services/PluginJob.qml; do
