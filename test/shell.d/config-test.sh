...
package_defaults = [
  ...
  ("default/systemd/user/omarchy-amd-soundwire-resume.service", "/usr/lib/systemd/user/omarchy-amd-soundwire-resume.service", "systemd/user/omarchy-amd-soundwire-resume.service"),
