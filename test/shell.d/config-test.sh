...
package_defaults = [
  ...
  ("default/systemd/user/omarchy-bluetooth-files.service", "/usr/lib/systemd/user/omarchy-bluetooth-files.service", "systemd/user/omarchy-bluetooth-files.service"),
