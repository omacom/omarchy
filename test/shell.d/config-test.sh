...
package_defaults = [
  ...
  ("default/systemd/user/omarchy-audio-mute-led-watch.service", "/usr/lib/systemd/user/omarchy-audio-mute-led-watch.service", "systemd/user/omarchy-audio-mute-led-watch.service"),
