...
package_defaults = [
  ...
  ("default/systemd/user/omarchy-keyboard-backlight.service", "/usr/lib/systemd/user/omarchy-keyboard-backlight.service", "systemd/user/omarchy-keyboard-backlight.service"),
