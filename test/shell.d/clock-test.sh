...
assertEqual(calendar.parseLifeExpectancy('200'), 200, 'calendar keeps a longer-than-typical life expectancy')
assertEqual(calendar.parseLifeExpectancy('369'), 369, 'calendar keeps a personal LIVE TO target instead of clamping to ninety')
assertEqual(calendar.parseLifeExpectancy('10000'), 90, 'calendar defaults a life expectancy past the field-width cap')
...
assertEqual(calendar.lifeProgressPercent(48, 369), 13, 'calendar measures life progress against a custom LIVE TO age')
