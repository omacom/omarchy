...
assert(/openPanelIndicatorWidth:.*showPercentage.*button\.contentWidth : 0/.test(panelSource), 'power spans the open-panel mark across the painted percentage block')
