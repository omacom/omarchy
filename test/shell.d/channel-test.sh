...
assert_log_line $'git\tclone\t--depth=1\t--\thttps://github.com/omacom/omarchy.git\t'"$checkout" "dev shallow-clones the source checkout to ~/omarchy"
