...
editor_cases=(
  ...
  'sublime subl pkg:sublime-text-4'
...
# Legacy sublime_text state resolves to subl
printf 'sublime_text\n' >"$test_home/.local/state/omarchy/defaults/editor"
[[ $(omarchy-default-editor) == "subl" ]] || fail "legacy sublime_text editor defaults to subl"
pass "legacy sublime_text editor defaults to subl"
