...
const expectedAgents = {
  ...
  'kiro-cli': { icon: '\ue90e', iconFont: 'omarchy', label: 'Kiro CLI' },
...
assertDeepEqual(
  defaultItems
    ...
    .map(item => item.label),
  ['Antigravity', 'Claude', 'Codex', 'Copilot', 'Crush', 'Cursor CLI', 'Grok', 'Hermes', 'Kiro CLI', 'Muse Code', 'omp', 'OpenClaw', 'OpenCode', 'Ori', 'Pi'],
