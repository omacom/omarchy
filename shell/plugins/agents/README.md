...
| `antigravity` | Agent bar cache rate limits (5-hour session + 7-day weekly) | `~/.gemini/antigravity-cli/history.jsonl` transcripts, conversation metadata, and model breakdown |
