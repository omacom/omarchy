...
prints the record contract (see the `claude`, `codex`, and `antigravity` collectors in
...
| `antigravity` | Local Stats Only | pi, omp, and opencode sessions using google-antigravity or gemini models |
