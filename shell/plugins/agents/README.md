...
| `cursor` | Cursor dashboard included monthly usage; Grok Bot weekly only when that quota is in use | Cursor dashboard aggregated and filtered usage events (account-wide) |
