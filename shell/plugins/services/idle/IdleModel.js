...
function keyboardBacklightTimeoutSeconds(idle) {
  return secondsFromConfig(idle && idle.keyboardBacklight, 0)
}
...
if (typeof module !== "undefined") {
  module.exports = {
    ...
    keyboardBacklightTimeoutSeconds: keyboardBacklightTimeoutSeconds,
