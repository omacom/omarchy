...
BarWidget {
  ...
  // On a pill, follow the pill text like the other widgets; without pills,
  // keep the theme text as before.
  readonly property color foreground: bar ? (bar.pillsOn ? bar.barForeground : bar.foreground) : Color.foreground
