...
BarWidget {
  ...
  Component {
    ...
    Item {
      ...
      // The block only ever takes the space the drawer actually shows: the
      // chevron plus whatever has been revealed so far. Collapsed it is just
      // the chevron; opening it grows the widget and pushes neighbouring
      // widgets out along the bar.
