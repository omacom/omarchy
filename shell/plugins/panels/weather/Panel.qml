...
Panel {
  ...
  readonly property bool useMetersPerSecond: !useImperial && Model.shouldUseMetersPerSecond(Qt.locale().name, reportCountry)
  ...
  readonly property string reportWind:      current ? (useImperial ? (current.windspeedMiles + " mph") : useMetersPerSecond ? (Model.kmphToMetersPerSecond(current.windspeedKmph) + " m/s") : (current.windspeedKmph + " km/h")) : ""
