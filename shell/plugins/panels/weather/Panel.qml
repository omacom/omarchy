...
Panel {
  ...
  // The bar combines the resolved condition icon with the current temperature;
  // `label` remains icon-only for the rest of the panel.
  readonly property string barLabel:        label + (reportTempNum !== "" ? " " + reportTempNum + tempUnit : "")
